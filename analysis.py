...
def top_three_articles():
	...
	print('--- Question: What are the most popular three articles of all time? ---')
...
def top_three_authors():
	...
	print('--- Question: Who are the most popular article authors of all time? ---')
...
def days_with_errors():
	...
	print('--- Question: On which days did more than one percent of requests lead to errors? ---')

	for error in execute_query:
		print (error[0].strftime('%A, %B %e, %Y') + ' -- ' + str(error[1]) + '%' + ' errors')
